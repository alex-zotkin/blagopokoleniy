...
<link rel="stylesheet" href="{{asset('css/admin/admin-eventsAdd.css')}}">
@extends("../layouts/admin-layout")

@section('bread')
    <div><a href="{{route('admin')}}">Администрирование</a>&nbsp;&nbsp;&nbsp;>>>&nbsp;&nbsp;&nbsp;<a href="{{route('adminEvents')}}"> Мероприятия</a>&nbsp;&nbsp;&nbsp;>>>&nbsp;&nbsp;&nbsp;<a href="{{route('adminEventsAdd')}}"> Создание мероприятия</a></div>
@stop
...
<section class="block">
    ...
    <form action="{{route('adminEventsAddPost')}}" enctype="multipart/form-data" id="form" method="post">
    {{ csrf_field() }}
            <ul>
            <li>
